<template>
  <div class="page-header-index-wide">
    ...
    <a-drawer
      ...
      :visible="visible"
    >
      <p class="groupTitle"><v-icon type="v-icongas-pump" style="color: #C47826; font-size: 22px"/> 油站信息</p>
      <a-row>
        <a-col :span="24">
          <div class="description">
            <p class="title">加油站名：</p>{{ gas.name }}
          </div>
        </a-col>
      </a-row>
      <a-row>
        <a-col :span="12">
          <div class="description">
            <p class="title">责任人：</p>{{ gas.user }}
          </div>
        </a-col>
        <a-col :span="12">
          <div class="description">
            <p class="title">创建时间：</p>{{ gas.create }}
          </div>
        </a-col>
      </a-row>
      <a-divider />
      <p class="groupTitle"><a-icon type="video-camera" style="color: #4DABF7; font-size: 22px"/> 监控信息</p>
      <a-row>
        <a-col :span="12">
          <div class="description">
            <p class="title">排烟温度：</p>{{ gas.temp }}℃
          </div>
        </a-col>
        <a-col :span="12">
          <div class="description">
            <p class="title">SCR前温度：</p>{{ gas.scrBefore }}℃
          </div>
        </a-col>
      </a-row>
      <a-row>
        <a-col :span="12">
          <div class="description">
            <p class="title">SCR后温度：</p>{{ gas.scrAfter }}℃
          </div>
        </a-col>
        <a-col :span="12">
          <div class="description">
            <p class="title">SCR前NO：</p>{{ gas.scrN0Before }}℃
          </div>
        </a-col>
      </a-row>
      <a-row>
        <a-col :span="12">
          <div class="description">
            <p class="title">SCR后NO：</p>{{ gas.scrN0After }}℃
          </div>
        </a-col>
        <a-col :span="12">
          <div class="description">
            <p class="title">超标时间：</p>{{ gas.scrN0AfterTime }}
          </div>
        </a-col>
      </a-row>
      <a-row>
        ...
        <a-col :span="12">
          <div class="description">
            <p class="title">超标时间：</p>{{ gas.create }}
          </div>
        </a-col>
      </a-row>
      <a-row>
        <a-col :span="24">
          <div class="description">
            <p class="title">清洗时间：</p>{{ gas.create }}
          </div>
        </a-col>
      </a-row>
      <a-row>
...
import carData from '@/assets/data/gas.json'
